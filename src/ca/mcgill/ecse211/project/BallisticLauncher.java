...
public class BallisticLauncher {
	...
	/**
	 * Returns the BallisticLauncher object. Use this method to obtain an instance
	 * of Launcher. Method used to make sure there is just one instance of
	 * BallisticLauncher throughout the code
	 * 
